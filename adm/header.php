      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        ...
        <ul class="navbar-nav">
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle text-white" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Homes
            </a>
            <ul class="dropdown-menu">
              ...
              <li><a class="dropdown-item" href="sethome.php">Home Settings</a></li>
            </ul>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle text-white" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Cabang
            </a>
            <ul class="dropdown-menu">
              <li><a class="dropdown-item" href="cabang.php">Cabang</a></li>
              <li>
                <hr class="dropdown-divider">
              </li>
              <li><a class="dropdown-item" href="setcab.php">Cabang Settings</a></li>
            </ul>
          </li>
          <li class="nav-item">
